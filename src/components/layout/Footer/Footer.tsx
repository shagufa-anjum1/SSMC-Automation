      ...
      <Container>
        ...
        <div className={styles.footerTop}>
          ...
          <div className={styles.column}>
            <div className={styles.logo}>
              <span className={styles.logoText}>SSMC</span>
              <span className={styles.logoSubtext}>Automation</span>
            </div>
            <p className={styles.description}>
              Leading manufacturer of precision plastic components and
              electronic device casings. Delivering quality automation solutions
              since 2005.
            </p>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>
            &copy; {currentYear} SSMC Automation. All rights reserved.
          </p>
